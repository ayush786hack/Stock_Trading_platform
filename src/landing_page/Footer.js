...
All rights reserved.</p>
        ...
        <div className="col">
          ...
          <br /> <br />
          <a href="#" className="text-decoration-none text-muted">Circular</a> <br /> <br />

          <a href="#" className="text-decoration-none text-muted">Z-Connect blog</a> <br /> <br />
          <a href="#" className="text-decoration-none text-muted">Downloads</a> <br /> <br />
        </div>
        <div className="col">
          ...
          <br /> <br />
          <a href="#" className="text-decoration-none text-muted">HUF demat account</a>
          <br /> <br />
...
NSE BSE MCX Terms & conditions Policies & procedures Privacy policy Disclosure For investor's attention Investor charter</p>
   </div>
    </div>
  </footer>
  );
